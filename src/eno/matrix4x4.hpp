...
template<typename _Ty>
class matrix4x4_template : public Matrix4x4<_Ty> {
public:
#define m11 m[0][0]
#define m12 m[0][1]
#define m13 m[0][2]
...
template<typename _Ty>
inline void multMatrix( matrix4x4_template<_Ty>& out, 
...
template<typename _Ty>
inline void addMatrix( matrix4x4_template<_Ty>& out,
    const matrix4x4_template<_Ty>& a,
    const matrix4x4_template<_Ty>& b )
{
    out = matrix4x4_template<_Ty>(
...
template<typename _Ty>
inline void subMatrix( matrix4x4_template<_Ty>& out,
    const matrix4x4_template<_Ty>& a,
    const matrix4x4_template<_Ty>& b )
{
    out = matrix4x4_template<_Ty>(
...
template<typename _Ty>
inline void addValueMatrix( matrix4x4_template<_Ty>& out,
    const matrix4x4_template<_Ty>& a,
    const _Ty value )
{
    out = matrix4x4_template<_Ty>(
...
template<typename _Ty>
inline void subtractValueMatrix( matrix4x4_template<_Ty>& out,
    const matrix4x4_template<_Ty>& a,
    const _Ty value )
{
    out = matrix4x4_template<_Ty>(
...
template<typename _Ty>
inline void multiplyValueMatrix( matrix4x4_template<_Ty>& out,
    const matrix4x4_template<_Ty>& a,
    const _Ty value )
{
    out = matrix4x4_template<_Ty>(
...
template<typename _Ty>
inline void devideValueMatrix( matrix4x4_template<_Ty>& out,
    const matrix4x4_template<_Ty>& a,
    const _Ty value )
{
    _Ty inv = 1.0/value;
...
template<typename _Ty>
struct matrixUtil {
    static void (* multiply)( matrix4x4_template<_Ty>&, 
        const matrix4x4_template<_Ty>&, 
        const matrix4x4_template<_Ty>& );

    static void (* add)( matrix4x4_template<_Ty>&,
        const matrix4x4_template<_Ty>&,
        const matrix4x4_template<_Ty>& );

    static void (* subtract)( matrix4x4_template<_Ty>&,
        const matrix4x4_template<_Ty>&,
        const matrix4x4_template<_Ty>& );

    static void (* addValue)( matrix4x4_template<_Ty>&,
        const matrix4x4_template<_Ty>&,
        const _Ty value );

    static void (* subtractValue)( matrix4x4_template<_Ty>&,
        const matrix4x4_template<_Ty>&,
        const _Ty value );

    static void (* multiplyValue)( matrix4x4_template<_Ty>&,
        const matrix4x4_template<_Ty>&,
        const _Ty value );

    static void (* devideValue)( matrix4x4_template<_Ty>&,
        const matrix4x4_template<_Ty>&,
        const _Ty value );
};

template<typename _Ty>
void (* matrixUtil<_Ty>::multiply)( matrix4x4_template<_Ty>& out, 
    const matrix4x4_template<_Ty>& first, 
    const matrix4x4_template<_Ty>& second ) = multMatrix;

template<typename _Ty>
void (* matrixUtil<_Ty>::add)( matrix4x4_template<_Ty>& out,
    const matrix4x4_template<_Ty>& first,
    const matrix4x4_template<_Ty>& second ) = addMatrix;

template<typename _Ty>
void (* matrixUtil<_Ty>::subtract)( matrix4x4_template<_Ty>&,
    const matrix4x4_template<_Ty>&,
    const matrix4x4_template<_Ty>& ) = subMatrix;

template<typename _Ty>
void (* matrixUtil<_Ty>::addValue)( matrix4x4_template<_Ty>&,
    const matrix4x4_template<_Ty>&,
    const _Ty value ) = addValueMatrix;

template<typename _Ty>
void (* matrixUtil<_Ty>::subtractValue)( matrix4x4_template<_Ty>&,
    const matrix4x4_template<_Ty>&,
    const _Ty value ) = subtractValueMatrix;

template<typename _Ty>
void (* matrixUtil<_Ty>::multiplyValue)( matrix4x4_template<_Ty>&,
    const matrix4x4_template<_Ty>&,
    const _Ty value ) = multiplyValueMatrix;

template<typename _Ty>
void (* matrixUtil<_Ty>::devideValue)( matrix4x4_template<_Ty>&,
    const matrix4x4_template<_Ty>&,
    const _Ty value ) = devideValueMatrix;

template<typename _Ty>
inline void multiplyMatrixSSE( matrix4x4_template<_Ty>& out,
    const matrix4x4_template<f32>& a,
    const matrix4x4_template<f32>& b )
{
    multMatrix(out, a, b);
}

template<>
inline void multiplyMatrixSSE( matrix4x4_template<f32>& out, 
    const matrix4x4_template<f32>& a, 
    const matrix4x4_template<f32>& b )
{
    f32 * dst = out.M;
...
template<typename _Ty>
inline void multMatrixSSE( matrix4x4_template<_Ty>& out, 
    const matrix4x4_template<_Ty>& a, 
    const matrix4x4_template<_Ty>& b )
{
...
template<typename _Ty>
inline void addMatrixSSE( matrix4x4_template<_Ty>& out,
    const matrix4x4_template<_Ty>& a,
    const matrix4x4_template<_Ty>& b )
{
    addMatrix(out, a, b);
...
template<>
inline void addMatrixSSE( matrix4x4_template<f32>& out,
    const matrix4x4_template<f32>& a,
    const matrix4x4_template<f32>& b )
{
    f32 * dst = out.M;
...
template<typename _Ty>
inline void subMatrixSSE( matrix4x4_template<_Ty>& out,
    const matrix4x4_template<_Ty>& a,
    const matrix4x4_template<_Ty>& b )
{
    subMatrix(out, a, b);
...
template<>
inline void subMatrixSSE( matrix4x4_template<f32>& out,
    const matrix4x4_template<f32>& a,
    const matrix4x4_template<f32>& b )
{
    f32 * dst = out.M;
...
template<typename _Ty>
inline void addValueMatrixSSE( matrix4x4_template<_Ty>& out,
    const matrix4x4_template<_Ty>& a,
    const _Ty value )
{
...
template<>
inline void addValueMatrixSSE( matrix4x4_template<f32>& out, 
    const matrix4x4_template<f32>& a, 
    const f32 value )
{
    f32 * dst = out.M;
...
template<typename _Ty>
inline void subtractValueMatrixSSE( matrix4x4_template<_Ty>& out,
    const matrix4x4_template<_Ty>& a,
    const _Ty value )
{
...
template<>
inline void subtractValueMatrixSSE( matrix4x4_template<f32>& out, 
    const matrix4x4_template<f32>& a, 
    const f32 value )
{
    f32 * dst = out.M;
...
template<typename _Ty>
inline void multiplyValueMatrixSSE( matrix4x4_template<_Ty>& out,
    const matrix4x4_template<_Ty>& a,
    const _Ty value )
{
...
template<>
inline void multiplyValueMatrixSSE( matrix4x4_template<f32>& out, 
    const matrix4x4_template<f32>& a, 
    const f32 value )
{
    f32 * dst = out.M;
...
template<typename _Ty>
inline void devideValueMatrixSSE( matrix4x4_template<_Ty>& out,
    const matrix4x4_template<_Ty>& a,
    const _Ty value )
{
...
template<>
inline void devideValueMatrixSSE( matrix4x4_template<f32>& out, 
    const matrix4x4_template<f32>& a, 
    const f32 value )
{
    f32 * dst = out.M;
